          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-6 shadow-sm space-y-2 sticky top-24">
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-5 py-4 rounded-2xl font-black text-sm transition-all ${
                activeSubTab === 'general' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-500/20' : 'text-slate-500 hover:bg-slate-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-5 py-4 rounded-2xl font-black text-sm transition-all ${
                activeSubTab === 'security' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-500/20' : 'text-slate-500 hover:bg-slate-50'
              }`}
            >
              <Shield size={20} /> 安全验证
            </button>
            <button 
              ...
              className={`w-full flex items-center gap-3 px-5 py-4 rounded-2xl font-black text-sm transition-all ${
                activeSubTab === 'api' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-500/20' : 'text-slate-500 hover:bg-slate-50'
              }`}
            >
              <Key size={20} /> API 引擎
            </button>
