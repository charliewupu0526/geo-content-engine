            ...
            >
              ...
              <div className="flex justify-between items-start mb-10 relative z-10">
                ...
                <div className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border ${
                  project.status === ProjectStatus.READY ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-indigo-50 text-indigo-600 border-indigo-100'
                }`}>
                  {project.status === ProjectStatus.READY ? 'Active' : project.status}
                </div>
              </div>

              <div className="relative z-10 space-y-2">
                <h3 className="text-2xl font-black text-slate-900 tracking-tighter group-hover:text-indigo-600 transition-colors uppercase italic">{project.name}</h3>
